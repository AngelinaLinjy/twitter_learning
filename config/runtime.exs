...
#
#     PHX_SERVER=true bin/auth_learning start
#
...
if config_env() == :prod do
  ...
  #
  #     config :auth_learning, AuthLearning.Mailer,
  ...
  config :auth_learning, :version, version: System.get_env("VERSION", "0.1.0-runtime")
end
